...
class SMDSegLoader(Dataset):
    def __init__(self, root_path, win_size, step=100, flag="train"):
        ...
        # test_data = np.load(os.path.join(root_path, "SMD_37_test.npy"))
        # print("using 37 dim test data")

        self.test = self.scaler.transform(test_data)
        # self.scaler_test = StandardScaler()
        # self.scaler_test.fit(test_data)
        # self.test = self.scaler_test.transform(test_data)
